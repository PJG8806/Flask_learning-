...
from flask_smorest import Api # 주솿에 /swagger-ui 입력시 app.config 설정에 따라 api 정보 문서화 보여줌
...
app.config["MYSQL_HOST"] = db_info['myslq_host']
app.config["MYSQL_USER"] = db_info['myslq_user']
...
api.register_blueprint(posts_blp) # 블루포인트 등록
